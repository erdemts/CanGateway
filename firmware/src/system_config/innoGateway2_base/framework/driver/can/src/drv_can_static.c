...
void DRV_CAN0_Initialize(void)
{
    ...
    PLIB_CAN_ChannelEventEnable(CAN_ID_1, CAN_CHANNEL1, CAN_RX_CHANNEL_ANY_EVENT);
    PLIB_CAN_FilterConfigure(CAN_ID_1, CAN_FILTER0, 0x00000000, CAN_EID);
    PLIB_CAN_FilterEnable(CAN_ID_1, CAN_FILTER0);

    PLIB_CAN_FilterMaskConfigure(CAN_ID_1, CAN_FILTER_MASK0, 0x00000000, CAN_EID, CAN_FILTER_MASK_ANY_TYPE);
    ...
    PLIB_CAN_ModuleEventEnable(CAN_ID_1 , 0|CAN_TX_EVENT|CAN_RX_EVENT|CAN_RX_OVERFLOW_EVENT|CAN_SYSTEM_ERROR_EVENT|CAN_BUS_ERROR_EVENT|CAN_INVALID_RX_MESSAGE_EVENT);
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0,INT_VECTOR_CAN1, INT_PRIORITY_LEVEL4);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0,INT_VECTOR_CAN1, INT_SUBPRIORITY_LEVEL2);
}
